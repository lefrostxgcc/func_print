...
START_TEST(test_nullu_width_minus5_pre0)
{
  char buffer[64];
  const char *format = "%-5.0u";
  int ac = ft_printf(format, 0);
...
START_TEST(test_nullu_width_minus5_predot)
{
  char buffer[64];
  const char *format = "%-5.u";
  int ac = ft_printf(format, 0);
...
START_TEST(test_nullo)
{
  char buffer[64];
  const char *format = "|%5.0o|%5.o|%-5.0o|%-5.o|";
  int ac = ft_printf(format, 0, 0, 0, 0);
  int ex = snprintf(buffer, sizeof buffer, format, 0, 0, 0, 0);
  ck_assert_pstr_eq(get_write_buf(), buffer);
  ck_assert_int_eq(ac, ex);
}
END_TEST
...
START_TEST(test_zerofloat3)
{
  char buffer[128];
  const char *format = "|%f|%f|%f|%f|%f|";
  double a = 9873.000001;
  double b = -875.000001;
  double c = -0.999999;
  double d = 0.0894255;
  double e = -5.0299999;
  int ac = ft_printf(format, a, b, c, d, e);
  int ex = snprintf(buffer, sizeof buffer, format, a, b, c, d, e);
  ck_assert_pstr_eq(get_write_buf(), buffer);
  ck_assert_int_eq(ac, ex);
}
END_TEST
...
START_TEST(test_zerofloat5)
{
  char buffer[128];
  const char *format = "|%.0f|%.1f|%.3f|%.7f|%.7f|";
  double a = -0.00032;
  double b = 23.00041;
  double c = 0.0000039;
  int ac = ft_printf(format, a, a, a, b);
  int ex = snprintf(buffer, sizeof buffer, format, a, a, a, b);
  ck_assert_pstr_eq(get_write_buf(), buffer);
  ck_assert_int_eq(ac, ex);
}
END_TEST

START_TEST(test_zerofloat6)
{
  char buffer[128];
  const char *format = "|%.7f|%.7f|%.7f|%.7f|";
  double a = -7.00036;
  double b = -0.000032;
  double c = 0.0000001;
  double d = -0.0000001;
...
START_TEST(test_prefix_percent)
{
  char buffer[128];
  const char *format = "hello %";
  int actual_result = ft_printf(format);
...
START_TEST(test_prefix_suffix_percent)
{
  char buffer[128];
  const char *format = "hello % www";
  int actual_result = ft_printf(format);
  int expected_result = 9;
  ck_assert_pstr_eq(get_write_buf(), "hello www");
  ck_assert_int_eq(actual_result, expected_result);
}
END_TEST

START_TEST(test_prefix_double_percent)
{
  char buffer[128];
  const char *format = "hello % %";
  int actual_result = ft_printf(format);
...
START_TEST(test_prefix_triple_percent)
{
  char buffer[128];
  const char *format = "hello % % %";
  int actual_result = ft_printf(format);
...
START_TEST(test_prefix_triple_percent_d2)
{
  char buffer[128];
  const char *format = "hello % % %d %";
  int actual_result = ft_printf(format, 5);
...
START_TEST(test_prefix_four_percent_d)
{
  char buffer[128];
  const char *format = "hello % % % %d %";
  int actual_result = ft_printf(format, 5);
  int expected_result = 11;
  ck_assert_pstr_eq(get_write_buf(), "hello % %d ");
  ck_assert_int_eq(actual_result, expected_result);
}
END_TEST

START_TEST(test_prefix_double_percent_d)
{
  char buffer[128];
  const char *format = "hello % %d %#0+ -";
  int actual_result = ft_printf(format, 5);
  int expected_result = 9;
  ck_assert_pstr_eq(get_write_buf(), "hello %d ");
  ck_assert_int_eq(actual_result, expected_result);
...
START_TEST(test_prefix_percent_d1)
{
  char buffer[128];
  const char *format = "hello % %d %#0+ - %% %";
  int actual_result = ft_printf(format, 5);
...
START_TEST(test_prefix_percent_df1)
{
  char buffer[128];
...
START_TEST(test_percent_width5_zero)
{
  const char *format = "%05%";
  int actual_result = ft_printf(format);
  int expected_result = 5;
  ck_assert_pstr_eq(get_write_buf(), "0000%");
  ck_assert_int_eq(actual_result, expected_result);
}
END_TEST

START_TEST(test_percent_width5_zero_pre3)
{
...
START_TEST(test_percent_width_minus5_zero_pre3)
{
  const char *format = "%-05.3%";
  int actual_result = ft_printf(format);
  int expected_result = 5;
...
START_TEST(test_percent_width_minus5_plus_zero_pre3)
{
  const char *format = "%-+05.3%";
  int actual_result = ft_printf(format);
  int expected_result = 5;
...
START_TEST(test_percent_width_minus3_space_plus_zero_pre6)
{
...
START_TEST(test_float19_3)
{
  char buffer[64];
  const char *format = "%.19f";
  int ac = ft_printf(format, 0.000000000000000000100);
  int ex = snprintf(buffer, sizeof buffer, format, 0.000000000000000000100);
  ck_assert_pstr_eq(get_write_buf(), buffer);
  ck_assert_int_eq(ac, ex);
}
END_TEST
...
START_TEST(test_float20_2)
{
  char buffer[64];
  const char *format = "%.20f";
  int ac = ft_printf(format, 1.025978548534310422034);
  int ex = snprintf(buffer, sizeof buffer, format, 1.025978548534310422034);
  ck_assert_pstr_eq(get_write_buf(), buffer);
  ck_assert_int_eq(ac, ex);
}
END_TEST

START_TEST(test_float20_3)
{
  char buffer[64];
  const char *format = "%.20f";
  int ac = ft_printf(format, 0.000000000000000000010);
  int ex = snprintf(buffer, sizeof buffer, format, 0.000000000000000000010);
  ck_assert_pstr_eq(get_write_buf(), buffer);
  ck_assert_int_eq(ac, ex);
}
END_TEST
...
Suite *ft_printf_suite(void)
{
  ...
  tcase_add_test(tc_nullu, test_nullu_width_minus5_pre0);
  tcase_add_test(tc_nullu, test_nullu_width_minus5_predot);

  tc_nullo = tcase_create("nullo");
  tcase_add_checked_fixture(tc_nullo, setup_ft_printf, teardown_ft_printf);
  tcase_add_test(tc_nullo, test_nullo);
  ...
  tcase_add_test(tc_error_type, test_prefix_percent);
  ...
  tcase_add_test(tc_error_type, test_prefix_triple_percent_d2);
  tcase_add_test(tc_error_type, test_prefix_four_percent_d);
  ...
  tcase_add_checked_fixture(tc_percent, setup_ft_printf, teardown_ft_printf);
  tcase_add_test(tc_percent, test_percent_width5_zero);
  ...
  tcase_add_test(tc_float20, test_float20_2);
  tcase_add_test(tc_float20, test_float20_3);
