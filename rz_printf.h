...
void rz_print_long(t_rz_buf *buf, t_rz_arg *f, long arg);
void rz_print_ldouble(t_rz_buf *buf, t_rz_arg *f, long double arg);
void rz_print_ulong(t_rz_buf *buf, t_rz_arg *f, unsigned long arg);
